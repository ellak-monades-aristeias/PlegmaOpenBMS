...
import org.openhab.binding.zwaveme.requests.GetDevicesRequest;
import org.openhab.binding.zwaveme.requests.GetParameterRequest;
import org.openhab.binding.zwaveme.requests.GetPlantOverviewRequest;
import org.openhab.binding.zwaveme.requests.GetProcessDataRequest;
 ...
 * @since 1.3.1
 */
public class ZWaveMeBoxBinding extends
		AbstractActiveBinding<ZwaveMeBindingProvider> implements
		ManagedService {

	private static final Logger logger = LoggerFactory
			.getLogger(ZWaveMeBoxBinding.class);
	...
	protected String getName() {
		return "ZWaveMe Refresh Service";
	}
	...
	protected void execute() {
		...
		logger.debug("execute() method of ZWaveMe is called!");
		...
		for (ZwaveMeBindingProvider provider : providers) {
	...
	class CacheConfig {
		...
		private ZWaveMeBoxBinding getOuterType() {
			return ZWaveMeBoxBinding.this;
		}
